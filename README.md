# PSOC&trade; Control C1 MCU: ACMP cmp

This code example demonstrates the usage of the analog comparator (ACMP) peripheral of PSOC&trade; Control C1 MCU.
...
[View this README on GitHub.](https://github.com/Infineon/mtb-example-ce242904-acmp-cmp)

[Provide feedback on this code example.](https://yourvoice.infineon.com/jfe/form/SV_1NTns53sK2yiljn?Q_EED=)
...
The following example clones the "[ACMP cmp](https://github.com/Infineon/mtb-example-ce242904-acmp-cmp)" application with the desired name "ACMP cmp" configured for the *KIT_PSC1M3_EVK* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSC1M3_EVK --app-id mtb-example-ce242904-acmp-cmp --user-app-name ACMP cmp --target-dir "C:/mtb_projects"
   ```
...
4. Connect VDD to P2.11 (ACMP_REF pin)

5. Connect GND to P2.6. The LED turns ON

6. Connect VDD to P2.6. The LED turns OFF
...
This example shows how the ACMP peripheral of the PSOC&trade; Control C1 MCU works. The implementation consists of the following three steps:

1. Selects and configures the ACMP using the `Cy_ACMP_Init()` function

2. Connects the divided reference 'VACMP_REF/2' to the positive input pin 'ACMP1.INP' by using the `Cy_ACMP_EnableReferenceDivider()` function

3. Enables the ACMP by using the `Cy_ACMP_EnableComparator()` function
...
| ACMP (PDL)      |COMPARATOR         | Analog comparator peripheral to compare IN-P and IN-N voltages      |
...
Document title: *CE242904* – *PSOC&trade; Control C1 MCU: ACMP cmp*
